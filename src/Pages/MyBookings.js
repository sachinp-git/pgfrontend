...
class MyBookings extends Component{
    ...
    render(){
        ...
        <Paper className={classes.root}>
         <div style={{display:"flex",flexDirection:"row",justifyContent:"space-between"}}>
          <Typography variant="headline" color="inherit" className={classes.caption} align="left">
            Appointments For {this.state.username}
          </Typography>       
          <Typography variant="headline" color="inherit" className={classes.caption} align="right">
            {this.state.timezone}
          </Typography> 
          </div>      
    ...
    componentDidMount(){
        if(!this.state.username){
            ...
            getUserBookingDetails(username,timezone).then((res)=>{
                this.setState({
                    appointMentData:[...res],
                    dataLoaded:true
                })
